...
export default function ProductCard({
  ...
  return (
    <div
      className={`${highlightStyles} rounded-xl pt-8 pb-4 px-8 flex flex-col min-h-[700px] gap-6 text-lg relative overflow-hidden shadow-xl`}
    >
      {isHighlighted && (
        <div className="absolute -right-[40px] top-[32px] bg-yellow-300 text-black px-12 py-1 rotate-45 text-sm font-medium shadow-lg">
