  ...
  return (
    <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
      {[1, 2, 3].map((index) => (
        <div
          key={index}
          className="border-2 border-neutral-300 rounded-xl pt-8 pb-4 px-8 flex flex-col min-h-[700px] relative overflow-hidden shadow-xl bg-white"
        >
          <ContentLoader
            speed={2}
            width={400}
          ...
          >
            ...
            <rect x="0" y="600" rx="4" ry="4" width="350" height="45" />
            <rect x="50" y="660" rx="3" ry="3" width="250" height="20" />
          </ContentLoader>
        </div>
      ))}
    </div>
