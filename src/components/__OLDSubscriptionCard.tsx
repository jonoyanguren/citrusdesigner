  ...
  return (
    <>
      ...
      <ConfirmModal
        ...
        message="¿Estás seguro de que deseas cancelar tu suscripción? Esta acción no se puede deshacer y perderás el acceso a las funciones premium al final del período actual."
        confirmText="Sí, cancelar suscripción"
        cancelText="No, mantener suscripción"
      />
    </>
  );
}
