...
export default function DesignEquivalencePage() {
  const t = useTranslations("designEquivalence");
  const { locale } = useParams();
  const categories = t.raw("categories") as Category[];
  const [openCategories, setOpenCategories] = useState<number[]>([0]); // Primera categoría abierta por defecto
