      ...
      <div className="container mx-auto px-4 py-12 relative mt-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white shadow-lg rounded-2xl p-8 flex flex-col gap-6">
            ...
            <h3 className="text-2xl font-bold">{translations.email.title}</h3>
            <p className="text-gray-600">{translations.email.description}</p>
            <Button
              variant="secondary"
              onClick={() => {
          ...
          <div className="bg-white shadow-lg rounded-2xl p-8 flex flex-col gap-6">
            ...
            <h3 className="text-2xl font-bold">{translations.chat.title}</h3>
            <p className="text-gray-600">{translations.chat.description}</p>
